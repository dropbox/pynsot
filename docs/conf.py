# -*- coding: utf-8 -*-
#
# pynsot documentation build configuration file, created by
# sphinx-quickstart on Thu Mar 10 17:18:55 2016.
#
...
project = u'pynsot'
copyright = u'2016, Jathan McCollum'
author = u'Jathan McCollum'
...
execfile(os.path.join(os.path.abspath('..'), 'pynsot/version.py'))
...
latex_documents = [
    (master_doc, 'pynsot.tex', u'pynsot Documentation',
...
man_pages = [
    (master_doc, 'pynsot', u'pynsot Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pynsot', u'pynsot Documentation',
     author, 'pynsot', 'One line description of project.',
     'Miscellaneous'),
]
